...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="https://www.vuisource.net/">VuiSource.Net</a></li>
      <li><a href="https://www.vuicode.net/">VuiCode.Net</a></li>
    </ul>
  </div>
</nav>
...
<script>
function copyTextToClipboard(e){var t=document.createElement("textarea");t.style.position="fixed",t.style.top=0,t.style.left=0,t.style.width="2em",t.style.height="2em",t.style.padding=0,t.style.border="none",t.style.outline="none",t.style.boxShadow="none",t.style.background="transparent",t.value=e,document.body.appendChild(t),t.select();try{document.execCommand("copy"),alert("Đã sao chép liên kết vào khay nhớ tạm thời! Code By Võ Hữu Nhân")}catch(o){alert("Không thể sao chép liên kết! Code By Võ Hữu Nhân")}document.body.removeChild(t)}function CopyLink(){copyTextToClipboard(location.href)}
</script>
<script>
function myFunction() {
    alert("Bạn đã lưu thành công ! Code By Võ Hữu Nhân");
}
</script>
